...
import { Play, RotateCcw, Check, Chrome as Home } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => setShowProgressPopup(!showProgressPopup)}
          >
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Next Day Preview */}
        <View style={styles.nextDayPreview}>
          <Text style={styles.nextDayText}>🔒 Day {currentDay + 1} sentences will unlock tomorrow</Text>
          <TouchableOpacity 
            style={styles.nextDayButton}
            onPress={() => setCurrentDay(prev => prev + 1)}
          >
            <Text style={styles.nextDayButtonText}>Unlock Next Day (Demo)</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
